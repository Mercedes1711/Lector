<?php
session_start();
include 'conexion_bd.php'; // Tu conexión PDO
include 'correo.php';       // Tu función enviarCorreo()
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$email) {
        ...
        if ($user) {
            ...
            // Preparar correo
            $reset_link = "http://localhost/dashboard/Lector/reset_password.php?token=" . $token;
